...
// Configurar persistência local para evitar conflitos entre dispositivos
...
loginForm.addEventListener('submit', async (e) => {
    ...
    try {
        ...
        if (!querySnapshot.empty) {
            ...
            // 4. Verifica se o array 'role' inclui 'Gerente' OU 'Recepcionista'
        ...
        if (error.code === 'auth/user-not-found' || error.code === 'auth/wrong-password' || error.code === 'auth/invalid-credential') {
            ...
            mensagemErro = "Acesso negado. Apenas gerentes ou recepcionistas podem entrar.";
